...
<div class="content-wrapper">
    ...
    // if (ingen brugernavn eller pass er sendt videre -> "Du har ikke tilladelse til at se denne side")
    // else (resten af siden)
    ...
    <center>
    <form action="Godkendelse.php" method="post">
        <button type="Submit" value="Submit" style="width:300px;">    Se medlemmer og ansøgninger    </button><br>
    </form>
    <form action="HoldListe.php" method="post">
        <button type="Submit" value="Submit" style="width:300px;">    Se de forskellige hold         </button>
    </form>
    </center>
